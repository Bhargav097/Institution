...
public class AuthRestAPIs {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
		if (userRepository.existsByUsername(signUpRequest.getFou_name())) {
		...
		User user = new User(signUpRequest.getInst_name(), signUpRequest.getFou_name(),signUpRequest.getAffiliation(), signUpRequest.getEmail(),
				encoder.encode(signUpRequest.getPassword()),  signUpRequest.getAddress(), signUpRequest.getShort_code(), signUpRequest.getAlt_email(), signUpRequest.getContact(), null);
